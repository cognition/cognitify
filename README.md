...
1. Detects a supported package manager (yum or dnf) and installs packages defined in `src/packages/GENERAL` and the distro-specific manifest (`PACKAGES_YUM`). Fully supports RHEL (Red Hat Enterprise Linux).
